function [Xellipse,Yellipse,X0,Y0] = error_ellipse(x,y,conf_int,plt)
...
% Get the inputed confidence interval error ellipse
chisquare_val = sqrt(chi2inv(conf_int,2));
...
Xellipse = r_ellipse(:,1);
Yellipse = r_ellipse(:,2);
