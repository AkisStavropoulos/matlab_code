...
for fh in os.listdir('C:\Data\\firefly_analysis\LFP_band\concatenation_with_accel'):
...
#session = 'm53s91'
    ...
    fhName = os.path.join('C:\Data\\firefly_analysis\LFP_band\concatenation_with_accel','%s.npz'%session)
    save_fld = ''
    ...
    cont_rate_filter = (unit_type == 'singleunit') #(cont_rate_filter < 0.35) & (unit_type == 'singleunit')
