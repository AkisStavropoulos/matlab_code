function [Output,Rat_X_GIA,Rat_X_GIAerror] = Motion_Cueing_noButter(time,Ball_X_Vel,Ball_Yaw_Vel,Parameters,prints)
% doesn't include Butterworth low-pass filter
...
Parameters.LPCutoff = 1 ; % Low pass filter, set to 100 to cancel it
Parameters.MC_tau = 1 ;
end
%%
