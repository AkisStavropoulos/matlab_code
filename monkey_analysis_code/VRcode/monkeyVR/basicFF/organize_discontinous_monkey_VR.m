...
outdata.ptbTrial =          data(:, 55); % logical for perturbation or not in the trial

ptbindx = logical(outdata.ptbTrial);
outdata.ptbLinVel(~ptbindx) = false;
outdata.ptbAngVel(~ptbindx) = false;
outdata.ptbStart(~ptbindx) = 0;
catch
